...
text = """........440...............418..643.....438......740.261......................................727...........................870..............
...
numbers_match = re.finditer("\d+", text_without_space)
valid_numbers = []

for m in numbers_match:
    start_pos, end_pos = m.regs[0]

    current_line_number = start_pos // line_length
    is_beginning_of_line = start_pos == 0 or start_pos % line_length == 0
    is_end_of_line = end_pos % line_length == line_length
    number = int(m.group())

    if not is_beginning_of_line and text_without_space[start_pos - 1] != ".":
        valid_numbers.append(number)
        continue

    if not is_end_of_line and text_without_space[end_pos] != ".":
        valid_numbers.append(number)
        continue

    # if it's not the first line we can check the line above
    if current_line_number > 0:
        line_above = lines[current_line_number - 1]
        diagonal_characters = (
            text_without_space[start_pos - line_length - 1 : end_pos - line_length + 1]
            .replace(".", "")
            .replace("\n", "")
        )
        if diagonal_characters:
            valid_numbers.append(number)
            continue

    # if it's not the last one, we can check the line below
